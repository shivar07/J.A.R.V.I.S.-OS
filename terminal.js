...
function handleCommand(cmdStr) {
  ...
  switch (baseCmd) {
    case "help":
      ...
      printLine("  <span style='color: var(--primary)'>socials</span>      - Print social links (YouTube, Portfolio)");
    ...
    case "socials":
      printLine("--- CONNECTED SOCIALS ---", "var(--primary)");
      ...
      printLine("• Portfolio: <a href='https://sujayr07.netlify.app/' target='_blank' style='color:#00f0ff; text-decoration: underline;'>Portfolio Link</a>");
      break;
    ...
    case "neofetch":
      ...
      printLine("<span style='color: var(--primary); font-weight: bold;'>user@robo-pc</span>");
      printLine("---------------------");
      printLine("<b>OS:</b> RoboOS v1.0.0 (RoboOS Kernel)");
